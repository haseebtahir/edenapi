...
public class CustomerDAOImpl implements CustomerDAO {
	...
	public Customer getCustDetails(String cust_email) throws Exception {
		...
		String query = "SELECT * FROM eden_db.customer where email_id_cus ='" + cust_email + "'";
	...
	public int addCustomer(CreateCustomer c) throws Exception {
		...
		final String INSERT_QUERY = "insert into eden_db.customer (email_id_cus, first_name, last_name, address, po_box"
				+ ", emirate, mobile_number, office_number, trade_licence ) values (:email_id_cus, :first_name, :last_name, :address, :po_box"
				+ ", :emirate, :mobile_number, :office_number, :trade_licence)";
	...
	public int addCompany(CreateCustomer c) throws Exception {
		...
		final String INSERT_QUERY = "insert into eden_db.company (company_name, company_logo, customer_id) values"
	...
	public List<Company> getCompanies(int customer_id) throws Exception {
		...
		String query = "SELECT * FROM eden_db.company where customer_id ='" + customer_id + "'";
	...
	public ArrayList<Product> getProducts(int companyID) throws Exception {
		String query = "SELECT * FROM eden_db.product where company_id ='" + companyID + "'";
	...
	public ArrayList<ProductPhoto> getProductPhotos(int productID) throws Exception {
		...
		String query = "SELECT * FROM eden_db.product_photo where product_id ='" + productID + "'";
	...
	public int deleteCustomer(int customerID) throws Exception {
		...
		final String DELETE_QUERY = "delete from eden_db.customer where customer_id = ?";
	...
	public int updateCustomer(CreateCustomer c) throws Exception {
		...
		String UPDATE_QUERY = "update eden_db.customer set email_id_cus = :email_id_cus,"
				+ " first_name = :first_name, last_name = :last_name, address = :address,"
				+ "po_box = :po_box, emirate = :emirate, mobile_number = :mobile_number,"
				+ "office_number = :office_number, trade_licence = :trade_licence  where customer_id = :customer_id";
		...
		try {
			...
			SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("customer_id", c.getCustomerID())
					...
					.addValue("trade_licence", c.getTradeLicence());
	...
	public List<Customer> getAllCustomers() throws Exception {
		...
		String query = "SELECT * FROM eden_db.customer";
	...
	public Company getCompany(int companyID) throws Exception {
		// User result = new User();
		String query = "SELECT * FROM eden_db.company where company_id ='" + companyID + "'";
	...
	public int deleteCompany(int companyID) throws Exception {
		...
		final String DELETE_QUERY = "delete from eden_db.company where company_id = ?";
	...
	public List<Company> getAllCompanies() throws Exception {
		// TODO Auto-generated method stub
		String query = "SELECT * FROM eden_db.company";
		List<Company> companyList = new ArrayList<Company>();
		List<Map<String, Object>> rows = new ArrayList<Map<String, Object>>();
	...
	public int addProduct(CreateProduct p) throws Exception {
		...
		final String INSERT_QUERY = "insert into eden_db.product (company_id, description, origin, price_range) values"
	...
	public Product getProduct(int productID) throws Exception {
		...
		String query = "SELECT * FROM eden_db.product where product_id ='" + productID + "'";
	...
	public int deleteProduct(int productID) throws Exception {
		...
		final String DELETE_QUERY = "delete from eden_db.product where product_id = ?";
	...
	public int updateProduct(CreateProduct p) throws Exception {
		...
		String UPDATE_QUERY = "update eden_db.product set company_id = :company_id, description = :description, origin = :origin,  price_range = :price_range "
	...
	public int addProductPhoto(CreateProductPhoto p) throws Exception {
		...
		final String INSERT_QUERY = "insert into eden_db.product_photo (product_photo, description, product_id) values"
	...
	public int deleteProductPhoto(int productPhotoId) throws Exception {
		...
		final String DELETE_QUERY = "delete from eden_db.product_photo where product_photo_id = ?";
	...
	public ProductPhoto getProductPhotobyID(int productPhotoID) throws Exception {
		String query = "SELECT * FROM eden_db.product_photo where product_photo_id ='" + productPhotoID + "'";
	...
	public int updateProductPhoto(CreateProductPhoto p) throws Exception {
		...
		String UPDATE_QUERY = "update eden_db.product_photo set product_photo = :product_photo, description = :description, product_id = :product_id"
	...
	public int updateCompany(CreateCompany c) throws Exception {
		...
		String UPDATE_QUERY = "update eden_db.company set company_name = :company_name, company_logo = :company_logo, customer_id = :customer_id"
	...
	public Customer getCustomerDetails(int customerID) throws Exception {
		...
		String query = "SELECT * FROM eden_db.customer where customer_id ='" + customerID + "'";
		Customer r = new Customer();
