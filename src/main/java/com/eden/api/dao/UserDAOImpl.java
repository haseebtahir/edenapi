...
public class UserDAOImpl implements UserDAO {
	...
	public User login(String _username, String _password) throws Exception {
		...
		// User result = new User();
		String query = "SELECT * FROM eden_db.users where email_id ='" + _username + "'";
		User r = new User();
	...
	public List<User> getAllByType(String userType) throws Exception {
		...
		String query = "SELECT * FROM eden_db.users where user_level ='" + userType + "'";
	...
	public List<User> getAllUsers() throws Exception {
		...
		String query = "SELECT * FROM eden_db.users";
		List<User> userList = new ArrayList<User>();
		List<Map<String, Object>> rows = new ArrayList<Map<String, Object>>();
	...
	public User getUserDetailsByEmpID(int employee_id) throws Exception {
		...
		// User result = new User();
		String query = "SELECT * FROM eden_db.users where employee_id ='" + employee_id + "'";
	...
	public int updateUserDetails(User u) throws Exception {
		...
		String UPDATE_QUERY = "update eden_db.users set email_id = :email_id,"
	...
	public int addUser(User u) throws Exception {
		...
		final String INSERT_QUERY = "insert into eden_db.users (email_id, password, user_level, password_hint,"
	...
	public int deleteUser(CreateUser u) {
		...
		final String DELETE_QUERY = "delete from eden_db.users where employee_id = ?";
